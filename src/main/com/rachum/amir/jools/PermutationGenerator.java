...
/**
 * Gets a list of objects and allows to either iterate over all the permutations
 * on it or get specific permutation by lexicographic ordering.
 *
 * @author Amir Rachum
 * @version 1.0
 * 
 * @param <T>
 *            the type of objects in the permutations
 */
public class PermutationGenerator<T> implements Iterator<List<T>>, Iterable<List<T>> {
	...
	/**
	 * @param list
	 *            a list of objects. The order of the list will define the
	 *            natural ordering of the objects. i.e., the given list order is
	 *            considered the first permutation.
	 * 
	...
	/**
	 * @param index
	 *            the index of the requested permutation, in lexicographic
	 *            order.
